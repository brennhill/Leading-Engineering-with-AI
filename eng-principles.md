...
# Brenn's engineering principles
These are my original principles for leading teams in the time before AI.  It comes from hard won experience. It's meant to keep things simple but actionable.  
There is a difference between simple and easy.  Leadership is simple. It's not that easy.  This is my guide, which is really just a solid baseline for new leaders.
When I coach people the same things come up over and over again.  There is no guide that gets you out of *practicing* leadership.
